...
function AboutPage() {
  ...
  useEffect(() => {
    if (leftDiv.current) {
      setHeight(leftDiv.current.offsetHeight);
    }
  }, [])
  ...
  return (
    <div className="m-4">
      ...
      <div className={styles.body_area}>
        <div ref={leftDiv} className={styles.left_area}>
          <LeftArea />
        </div>
        <div className={styles.right_area} style={{ height: `${height}px` }}><RightArea /></div>
      </div>
    </div>
  )
}
...
function FTDArticleList() {
  ...
  return (
    <div className="mt-8 flex flex-col h-inherit overflow-hidden">
      <div className="
              bg-gray-400 bg-opacity-10 rounded-3xl p-5
              overflow-y-auto
